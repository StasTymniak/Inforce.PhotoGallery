...
{
    /// <inheritdoc />
    public partial class add_album_image_useractivities_tables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserActivities", x => new { x.UserId, x.ImageId });
                    table.ForeignKey(
                        name: "FK_UserActivities_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActivities_ImageId",
